####This is a python version of the original 'mantel.test.R' file from ape package (https://www.rdocumentation.org/packages/ape/versions/5.6-2/topics/mantel.test).
...
def mantel_test(m1, m2, nperm=999, alternative = "two.sided"):
    mant_out = {"z.stat": -1, "p": -1, "alternative": alternative}
